import 'package:bakerieswepapp/Screens/finished_product_inventory/widgets/add_edit_dialog/finished_product_inventory_form.dart';
...
class AddFinishedProductInventoryDialog extends StatelessWidget {
  final bool isEdit;
  final Map<String, dynamic>? stockData;
  final Function(Map<String, dynamic>)? onAdd;
  final Function(Map<String, dynamic>)? onEdit;

  const AddFinishedProductInventoryDialog({
    Key? key,
    this.isEdit = false,
    this.stockData,
    this.onAdd,
  ...
  Widget build(BuildContext context) {
    return AlertDialog(
      ...
      content: FinishedProductInventoryForm(
        isEdit: isEdit,
        stockData: stockData,
