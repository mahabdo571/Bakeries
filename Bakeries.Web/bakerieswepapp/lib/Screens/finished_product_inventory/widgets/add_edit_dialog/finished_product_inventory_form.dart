...
class FinishedProductInventoryForm extends StatefulWidget {
  final bool isEdit;
  final Map<String, dynamic>? stockData;
  final Function(Stock) onSubmit;

  const FinishedProductInventoryForm({
    Key? key,
  ...
  @override
  _FinishedProductInventoryFormState createState() => _FinishedProductInventoryFormState();
}

class _FinishedProductInventoryFormState extends State<FinishedProductInventoryForm> {
