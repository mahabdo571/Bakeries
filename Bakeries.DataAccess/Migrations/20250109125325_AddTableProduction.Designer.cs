...
namespace Bakeries.DataAccess.Migrations
{
    ...
    [Migration("20250109125325_AddTableProduction")]
    partial class AddTableProduction
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Bakeries.DataAccess.Entities.ProductionModel", b =>
                {
                    b.HasOne("Bakeries.DataAccess.Entities.ProductsModel", "Product")
                        .WithOne("Production")
                        .HasForeignKey("Bakeries.DataAccess.Entities.ProductionModel", "ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
