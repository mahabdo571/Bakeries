...
namespace Bakeries.DataAccess.Migrations
{
    ...
    [Migration("20250226110952_changeRelation")]
            ...
            modelBuilder.Entity("Bakeries.DataAccess.Entities.ProductionModel", b =>
                {
                    ...
                    b.Property<int?>("PurchaseFinishedProductInventoryId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Bakeries.DataAccess.Entities.PurchaseFinishedProductInventoryModel", b =>
                {
                    ...
                    b.HasIndex("PurchaseFinishedProductInventoryId");
            ...
            modelBuilder.Entity("Bakeries.DataAccess.Entities.PurchaseFinishedProductInventoryModel", b =>
                {
                    ...
                    b.HasOne("Bakeries.DataAccess.Entities.ProductionModel", null)
                        .WithMany("PFPIM")
                        .HasForeignKey("PurchaseFinishedProductInventoryId");
